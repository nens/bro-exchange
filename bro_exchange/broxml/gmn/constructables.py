...
def gen_eventdate(data, nsmap):
    ...
    if choice == 'date':
        date = etree.SubElement(eventDate, ("{%s}" % nsmap['brocom']) + 'date', nsmap=nsmap)
        date.text = text
    elif choice == 'year':
        date = etree.SubElement(eventDate, ("{%s}" % nsmap['brocom']) + 'year', nsmap=nsmap)
        date.text = text      
    elif choice == 'yearMonth':
        date = etree.SubElement(eventDate, ("{%s}" % nsmap['brocom']) + 'yearMonth', nsmap=nsmap)
        date.text = text  
    elif text == None:
        date = etree.SubElement(eventDate, ("{%s}" % nsmap['brocom']) + 'voidReason', nsmap=nsmap)
        date.text = choice 
